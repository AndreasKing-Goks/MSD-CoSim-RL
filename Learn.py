...
y_desired           = 1.0       # The desired y position for the mass
...
force               = 20        # Magnitude of control force (fixed)
...
# # FOR LEARNING
# n_episode_value = 1000  # Number of episodes required to compute the action value
# n_episode_score = 100   # Number of episodes required for socring te policy
# alpha=0.1               # Learning rate
# gamma=0.9                # Reward discount rate
# max_n_steps=1000        # Maximum number of steps in a single episodes
# print_every=100          # The episodes when t he score is printed
# epsilon = 1.0            # Explorative coefficient
# epsilon_decay = 0.999   # Decays the epsilon as the episodes goes
# epsilon_min = 0.01       # The minimum epsilon after decay
